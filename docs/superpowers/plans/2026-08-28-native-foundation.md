...
| 3 | Private atomic files, cross-process locks, detached workers, bounded schedule | `internal/store/files.go`, `files_windows.go`, `files_darwin.go`, `lock.go`, `lock_windows.go`, `lock_darwin.go`, `files_test.go`, `lock_test.go`; `internal/worker/spawn.go`, `spawn_windows.go`, `spawn_darwin.go`, `delivery.go`, `spawn_test.go`, `delivery_test.go`; source manifest |
